      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-white/10 pb-4">
        <button 
          ...
          className={`flex items-center gap-2 px-4 py-2 font-semibold text-sm transition-all rounded-lg ${
            tab === 'publisher' ? 'bg-[var(--primary-color)] text-[#1a1a1a]' : 'text-slate-400 hover:text-white hover:bg-white/5'
          }`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-2 px-4 py-2 font-semibold text-sm transition-all rounded-lg ${
            tab === 'calendar' ? 'bg-[var(--primary-color)] text-[#1a1a1a]' : 'text-slate-400 hover:text-white hover:bg-white/5'
          }`}
        >
        ...
        <button 
          onClick={() => setTab('feed')} 
          className={`flex items-center gap-2 px-4 py-2 font-semibold text-sm transition-all rounded-lg ${
            tab === 'feed' ? 'bg-[var(--primary-color)] text-[#1a1a1a]' : 'text-slate-400 hover:text-white hover:bg-white/5'
          }`}
        >
